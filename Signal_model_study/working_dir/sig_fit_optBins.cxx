...
void fit_hist_DSCB(RooDataHist &h_ul, RooDataHist &h_re, RooRealVar &x, string def_name){
  ...
  string outputfile = "optBins/fit_results/" + name + ".txt";
  if (OUTPUT) freopen (outputfile.c_str(),"w",stdout);

  RooRealVar mu("mu", "mu", 124.57, 120., 130.);
  RooRealVar alphaL("alphaL", "alphaL", 7.2-01, 0.001,2.3);
  RooRealVar alphaR("alphaR", "alphaR", 1.57, 0.001, 2.5);
  RooRealVar nL("nL", "nL", 40, 1., 120);
  RooRealVar nR("nR", "nR", 20, 1., 150);
  RooRealVar sigmaL("sigmaL", "sigmaL", 1.8, 0.5, 3.);
...
//Set alpha or n constant
  ...
  double muVal1 = mu.getVal();
  double muError1 = mu.getError();
  ...
  c2->cd(2);
  nllframe1->Draw();
  if (OUTPUT) c2->SaveAs(((string)("optBins/NLLplots/" + name + "UL.pdf")).c_str());
  ...
  double muVal2 = mu.getVal();
  double muError2 = mu.getError();
  ...
  c3->cd(2);
  nllframe2->Draw();
  if (OUTPUT) c3->SaveAs(((string)("optBins/NLLplots/" + name + "Re.pdf")).c_str());
  ...
  stream << std::fixed << std::setprecision(2) << s1 << "#pm" << e1  << " #mu = " <<  muVal1 << "#pm" << muError1 << "}{" << "nL = " << nl1 << "#pm" << nl1e << " nR = " << nr1 << "#pm" << nr1e << "}}{#splitline{" << 
  ...
  stream1 << std::fixed << std::setprecision(2) << s2 << "#pm" << e2  << " #mu = " <<  muVal1 << "#pm" << muError1 << "}{" << "nL = " << nl2 << "#pm" << nl2e << " nR = " << nr2 << "#pm" << nr2e << "}}{#splitline{" << 
  ...
  leg->Draw("same");
  if (OUTPUT) c4->SaveAs(((string)("optBins/plots/" + name + ".pdf")).c_str());
...
void sig_fit_optBins(){
  ...
  RooDataSet f_data_sig_ul("f_data_sig", "f_data_sig", ULsample, RooArgSet(x, y, bdt, w, year, lep, ph_eta, nlep, njet), "year == 2016","w");
  RooDataSet f_data_sig("f_data_sig", "f_data_sig", Rerecosample, RooArgSet(x, y, bdt, w, year, lep, ph_eta, nlep, njet), "year == 2016","w");

  RooDataSet * d_el_u1 = (RooDataSet*)f_data_sig.reduce(RooArgSet(x,ph_eta),"lep < 1 && nlep <= 2 && njet < 2 && bdt > 0.093");
  RooDataSet *  d_el_u2 = (RooDataSet*)f_data_sig.reduce(RooArgSet(x,ph_eta),"lep < 1 && nlep <= 2 && njet < 2 && bdt < 0.093 && bdt > 0.063");
  RooDataSet * d_el_u3 = (RooDataSet*)f_data_sig.reduce(RooArgSet(x,ph_eta),"lep < 1 && nlep <= 2 && njet < 2 && bdt < 0.063 && bdt > 0.007");
  RooDataSet * d_el_u4 = (RooDataSet*)f_data_sig.reduce(RooArgSet(x,ph_eta),"lep < 1 && nlep <= 2 && njet < 2 && bdt < 0.007 && bdt > -0.05");

  RooDataSet * d_mu_u1 = (RooDataSet*)f_data_sig.reduce(RooArgSet(x,ph_eta),"lep > 0 && nlep <= 2 && njet < 2 && bdt > 0.093");
  RooDataSet *  d_mu_u2 = (RooDataSet*)f_data_sig.reduce(RooArgSet(x,ph_eta),"lep > 0 && nlep <= 2 && njet < 2 && bdt < 0.093 && bdt > 0.063");
  RooDataSet * d_mu_u3 = (RooDataSet*)f_data_sig.reduce(RooArgSet(x,ph_eta),"lep > 0 && nlep <= 2 && njet < 2 && bdt < 0.063 && bdt > 0.007");
  RooDataSet * d_mu_u4 = (RooDataSet*)f_data_sig.reduce(RooArgSet(x,ph_eta),"lep > 0 && nlep <= 2 && njet < 2 && bdt < 0.007 && bdt > -0.05");
  ...
  RooDataSet *  d_el_ul_u1 = (RooDataSet*)f_data_sig_ul.reduce(RooArgSet(x,ph_eta),"lep < 1 && nlep <= 2 && njet < 2 && bdt > 0.093");
  RooDataSet *  d_el_ul_u2 = (RooDataSet*)f_data_sig_ul.reduce(RooArgSet(x,ph_eta),"lep < 1 && nlep <= 2 && njet < 2 && bdt < 0.093 && bdt > 0.063");
  RooDataSet *  d_el_ul_u3 = (RooDataSet*)f_data_sig_ul.reduce(RooArgSet(x,ph_eta),"lep < 1 && nlep <= 2 && njet < 2 && bdt < 0.063 && bdt > 0.007");
  RooDataSet *  d_el_ul_u4 = (RooDataSet*)f_data_sig_ul.reduce(RooArgSet(x,ph_eta),"lep < 1 && nlep <= 2 && njet < 2 && bdt < 0.007 && bdt > -0.05");

  RooDataSet *  d_mu_ul_u1 = (RooDataSet*)f_data_sig_ul.reduce(RooArgSet(x,ph_eta),"lep > 0 && nlep <= 2 && njet < 2 && bdt > 0.093");
  RooDataSet *  d_mu_ul_u2 = (RooDataSet*)f_data_sig_ul.reduce(RooArgSet(x,ph_eta),"lep > 0 && nlep <= 2 && njet < 2 && bdt < 0.093 && bdt > 0.063");
  RooDataSet *  d_mu_ul_u3 = (RooDataSet*)f_data_sig_ul.reduce(RooArgSet(x,ph_eta),"lep > 0 && nlep <= 2 && njet < 2 && bdt < 0.063 && bdt > 0.007");
  RooDataSet *  d_mu_ul_u4 = (RooDataSet*)f_data_sig_ul.reduce(RooArgSet(x,ph_eta),"lep > 0 && nlep <= 2 && njet < 2 && bdt < 0.007 && bdt > -0.05");
  ...
  */
  ...
  fit_hist_DSCB(h_el_ul_u1, h_el_u1, x, "2016 Ele Untagged 1");
  fit_hist_DSCB(h_el_ul_u2, h_el_u2, x, "2016 Ele Untagged 2");
  fit_hist_DSCB(h_el_ul_u3, h_el_u3, x, "2016 Ele Untagged 3");
  fit_hist_DSCB(h_el_ul_u4, h_el_u4, x, "2016 Ele Untagged 4");

  fit_hist_DSCB(h_mu_ul_u1, h_mu_u1, x, "2016 Muon Untagged 1");
  fit_hist_DSCB(h_mu_ul_u2, h_mu_u2, x, "2016 Muon Untagged 2");
  fit_hist_DSCB(h_mu_ul_u3, h_mu_u3, x, "2016 Muon Untagged 3");
  fit_hist_DSCB(h_mu_ul_u4, h_mu_u4, x, "2016 Muon Untagged 4");

  // fit_hist_CB(h_el_ul_u1, h_el_u1, x, "2016 Ele Untagged 1");
  // fit_hist_CB(h_el_ul_u2, h_el_u2, x, "2016 Ele Untagged 2");
  // fit_hist_CB(h_el_ul_u3, h_el_u3, x, "2016 Ele Untagged 3");
  // fit_hist_CB(h_el_ul_u4, h_el_u4, x, "2016 Ele Untagged 4");

  // fit_hist_CB(h_mu_ul_u1, h_mu_u1, x, "2016 Muon Untagged 1");
  // fit_hist_CB(h_mu_ul_u2, h_mu_u2, x, "2016 Muon Untagged 2");
  // fit_hist_CB(h_mu_ul_u3, h_mu_u3, x, "2016 Muon Untagged 3");
  // fit_hist_CB(h_mu_ul_u4, h_mu_u4, x, "2016 Muon Untagged 4");

  // fit_hist_CBGauss(h_el_ul_u1, h_el_u1, x, "2016 Ele Untagged 1");
  //fit_hist_CBGauss(h_el_ul_u2, h_el_u2, x, "2016 Ele Untagged 2");
  // fit_hist_CBGauss(h_el_ul_u3, h_el_u3, x, "2016 Ele Untagged 3");
  // fit_hist_CBGauss(h_el_ul_u4, h_el_u4, x, "2016 Ele Untagged 4");

  // fit_hist_CBGauss(h_mu_ul_u1, h_mu_u1, x, "2016 Muon Untagged 1");
  // fit_hist_CBGauss(h_mu_ul_u2, h_mu_u2, x, "2016 Muon Untagged 2");
  // fit_hist_CBGauss(h_mu_ul_u3, h_mu_u3, x, "2016 Muon Untagged 3");
  // fit_hist_CBGauss(h_mu_ul_u4, h_mu_u4, x, "2016 Muon Untagged 4");
