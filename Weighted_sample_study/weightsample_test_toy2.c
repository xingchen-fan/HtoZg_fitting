...
// Toy2 script, explicit weight function: fitTo and chi2FitTo, two options, please choose as intended. Please remmber chi2FitTo doesn't have asymptotic error option!
...
//w(x) = 0.4x + 0.5
        auto data1 = line3.generate(x, NumEvents(20000));
