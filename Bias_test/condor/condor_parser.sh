...
./Bias_test_combineToy_condor.py -n 5 -i $1 -f $2 -c $3 -s $4 -conB ../../Config/config_xgboost_vhtth.json -conS ../../Config/config_DSCB_sys_vhtth_v1p4p0.json -t pruneUnstable> $2_$3_$4sig/output$1.txt 2>&1
