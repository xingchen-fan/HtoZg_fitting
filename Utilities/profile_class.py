...
class profileClass:
    def __init__(self, x, mu_gauss, cat='', config=''):
        ...
        self.pow1_model = Pow1Class(x, mu_gauss, cat, setting["pow1"]['sigma_init'], setting["pow1"]['sigma2_init'], setting["pow1"]['step_init'], setting["pow1"]['p_init'], setting["pow1"]['p_low'], setting["pow1"]['p_high'], setting["pow1"]['di_gauss'], setting["pow1"]['fix_sigma'], setting["pow1"]['gc_init'])
        self.pow2_model = Pow2Class(x, mu_gauss, cat, setting["pow2"]['sigma_init'], setting["pow2"]['sigma2_init'], setting["pow2"]['step_init'], setting["pow2"]['p1_init'], setting["pow2"]['p1_low'], setting["pow2"]['p1_high'], setting["pow2"]['p2_init'], setting["pow2"]['p2_low'], setting["pow2"]['p2_high'], setting["pow2"]['f1_init'], setting["pow2"]['f2_init'], setting["pow2"]['xmax'], setting["pow2"]['const_f1'], setting["pow2"]['di_gauss'], setting["pow2"]['fix_sigma'], setting["pow2"]['gc_init'])
        self.pow3_model = Pow3Class(x, mu_gauss, cat,setting["pow3"]['sigma_init'], setting["pow1"]['sigma2_init'], setting["pow3"]['step_init'], setting["pow3"]['p1_init'], setting["pow3"]['p1_low'], setting["pow3"]['p1_high'], setting["pow3"]['p2_init'], setting["pow3"]['p2_low'], setting["pow3"]['p2_high'], setting["pow3"]['p3_init'], setting["pow3"]['p3_low'], setting["pow3"]['p3_high'], setting["pow3"]['f1_init'], setting["pow3"]['f2_init'], setting["pow3"]['f3_init'], setting["pow3"]['xmax'], setting["pow3"]['const_f1'], setting["pow3"]['di_gauss'], setting["pow3"]['fix_sigma'], setting["pow3"]['gc_init'])
        
        self.exp1_model = Exp1Class(x, mu_gauss, cat, setting["exp1"]['sigma_init'], setting["exp1"]['sigma2_init'], setting["exp1"]['step_init'], setting["exp1"]['p_init'], setting["exp1"]['p_low'], setting["exp1"]['p_high'], setting["exp1"]['di_gauss'], setting["exp1"]['fix_sigma'], setting["exp1"]['gc_init'])
        self.exp2_model = Exp2Class(x, mu_gauss, cat, setting["exp2"]['sigma_init'], setting["exp2"]['sigma2_init'], setting["exp2"]['step_init'], setting["exp2"]['p1_init'], setting["exp2"]['p1_low'], setting["exp2"]['p1_high'], setting["exp2"]['p2_init'], setting["exp2"]['p2_low'], setting["exp2"]['p2_high'], setting["exp2"]['f1_init'], setting["exp2"]['f2_init'], setting["exp2"]['xmax'], setting["exp2"]['const_f1'], setting["exp2"]['di_gauss'], setting["exp2"]['fix_sigma'], setting["exp2"]['gc_init'])
        self.exp3_model = Exp3Class(x, mu_gauss, cat, setting["exp3"]['sigma_init'], setting["exp3"]['sigma2_init'], setting["exp3"]['step_init'], setting["exp3"]['p1_init'], setting["exp3"]['p1_low'], setting["exp3"]['p1_high'], setting["exp3"]['p2_init'], setting["exp3"]['p2_low'], setting["exp3"]['p2_high'], setting["exp3"]['p3_init'], setting["exp3"]['p3_low'], setting["exp3"]['p3_high'], setting["exp3"]['f1_init'], setting["exp3"]['f2_init'], setting["exp3"]['f3_init'], setting["exp3"]['xmax'], setting["exp3"]['const_f1'], setting["exp3"]['di_gauss'], setting["exp3"]['fix_sigma'], setting["exp3"]['gc_init'])
        
        self.lau2_model = Lau2Class(x, mu_gauss, cat, setting["lau2"]['sigma_init'], setting["lau2"]['sigma2_init'], setting["lau2"]['step_init'], setting["lau2"]['p1'], setting["lau2"]['p2'], setting["lau2"]['f1_init'], setting["lau2"]['f2_init'], setting["lau2"]['xmax'], setting["lau2"]['const_f1'], setting["lau2"]['di_gauss'], setting["lau2"]['fix_sigma'], setting["lau2"]['gc_init'])
        self.lau3_model = Lau3Class(x, mu_gauss, cat, setting["lau3"]['sigma_init'], setting["lau3"]['sigma2_init'], setting["lau3"]['step_init'], setting["lau3"]['p1'], setting["lau3"]['p2'], setting["lau3"]['p3'], setting["lau3"]['f1_init'], setting["lau3"]['f2_init'], setting["lau3"]['f3_init'], setting["lau3"]['xmax'], setting["lau3"]['const_f1'], setting["lau3"]['di_gauss'], setting["lau3"]['fix_sigma'], setting["lau3"]['gc_init'])
        self.lau4_model = Lau4Class(x, mu_gauss, cat, setting["lau4"]['sigma_init'], setting["lau4"]['sigma2_init'], setting["lau4"]['step_init'], setting["lau4"]['p1'], setting["lau4"]['p2'], setting["lau4"]['p3'], setting["lau4"]['p4'], setting["lau4"]['f1_init'], setting["lau4"]['f2_init'], setting["lau4"]['f3_init'], setting["lau4"]['f4_init'], setting["lau4"]['xmax'], setting["lau4"]['const_f1'], setting["lau4"]['di_gauss'], setting["lau4"]['fix_sigma'], setting["lau4"]['gc_init'])
