...
class profileClass:
    def __init__(self, x, mu_gauss, cat='', config=''):
        ...
        self.bern5_model = Bern5Class(x, mu_gauss, cat, setting["bern5"]['p0'], setting["bern5"]['p1'], setting["bern5"]['p2'], setting["bern5"]['p3'], setting["bern5"]['p4'], setting["bern5"]['p5'], setting["bern5"]['bond'],setting["bern5"]['sigma'], setting["bern5"]['sigma2'], setting["bern5"]['step'], setting["bern5"]['di_gauss'], setting["bern5"]['fix_sigma'], setting["bern5"]['gc'])
        self.bern2_range_model = Bern2RangeClass(x, mu_gauss, cat, setting["bern2"]['p0'], setting["bern2"]['p1'], setting["bern2"]['p2'], setting["bern2"]['bond'],setting["bern2"]['sigma'],setting["bern2"]['step'], setting["bern2"]['fix_sigma'], setting["Range"][0], setting["Range"][1])
        self.bern3_range_model = Bern3RangeClass(x, mu_gauss, cat, setting["bern3"]['p0'], setting["bern3"]['p1'], setting["bern3"]['p2'], setting["bern3"]['p3'], setting["bern3"]['bond'],setting["bern3"]['sigma'],setting["bern3"]['step'], setting["bern3"]['fix_sigma'], setting["Range"][0], setting["Range"][1])
        self.bern4_range_model = Bern4RangeClass(x, mu_gauss, cat, setting["bern4"]['p0'], setting["bern4"]['p1'], setting["bern4"]['p2'], setting["bern4"]['p3'], setting["bern4"]['p4'], setting["bern4"]['bond'],setting["bern4"]['sigma'],setting["bern4"]['step'], setting["bern4"]['fix_sigma'], setting["Range"][0], setting["Range"][1])
        self.bern5_range_model = Bern5RangeClass(x, mu_gauss, cat, setting["bern5"]['p0'], setting["bern5"]['p1'], setting["bern5"]['p2'], setting["bern5"]['p3'], setting["bern5"]['p4'], setting["bern5"]['p5'], setting["bern5"]['bond'],setting["bern5"]['sigma'],setting["bern5"]['step'], setting["bern5"]['fix_sigma'], setting["Range"][0], setting["Range"][1])
        ...
        self.lau2_model = Lau2Class(x, mu_gauss, cat, setting["lau2"]['sigma'], setting["lau2"]['sigma2'], setting["lau2"]['step'], setting["lau2"]['p1'], setting["lau2"]['p2'], setting["lau2"]['f1'], setting["lau2"]['f2'], setting["Range"][1], setting["lau2"]['const_f1'], setting["lau2"]['di_gauss'], setting["lau2"]['fix_sigma'], setting["lau2"]['gc'])
        self.lau3_model = Lau3Class(x, mu_gauss, cat, setting["lau3"]['sigma'], setting["lau3"]['sigma2'], setting["lau3"]['step'], setting["lau3"]['p1'], setting["lau3"]['p2'], setting["lau3"]['p3'], setting["lau3"]['f1'], setting["lau3"]['f2'], setting["lau3"]['f3'], setting["Range"][1], setting["lau3"]['const_f1'], setting["lau3"]['di_gauss'], setting["lau3"]['fix_sigma'], setting["lau3"]['gc'])
        self.lau4_model = Lau4Class(x, mu_gauss, cat, setting["lau4"]['sigma'], setting["lau4"]['sigma2'], setting["lau4"]['step'], setting["lau4"]['p1'], setting["lau4"]['p2'], setting["lau4"]['p3'], setting["lau4"]['p4'], setting["lau4"]['f1'], setting["lau4"]['f2'], setting["lau4"]['f3'], setting["lau4"]['f4'], setting["Range"][1], setting["lau4"]['const_f1'], setting["lau4"]['di_gauss'], setting["lau4"]['fix_sigma'], setting["lau4"]['gc'])
        ...
        self.agg_model = AGGClass(x, cat, setting["agg"]['kappa'], setting["agg"]['alpha'], setting["agg"]['zeta'], setting["Range"][0], setting["Range"][1])
