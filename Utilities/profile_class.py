...
class profileClass:
    def __init__(self, x, mu_gauss, cat='', config=''):
        ...
        self.lau2_model = Lau2Class(x, mu_gauss, cat, setting["lau2"]['sigma'], setting["lau2"]['step'], setting["lau2"]['p1'], setting["lau2"]['p2'], setting["lau2"]['f1'], setting["lau2"]['xmax'], setting["lau2"]['const_f1'], setting["lau2"]['di_gauss'], setting["lau2"]['fix_sigma'])
        self.lau3_model = Lau3Class(x, mu_gauss, cat, setting["lau3"]['sigma'], setting["lau3"]['step'], setting["lau3"]['p1'], setting["lau3"]['p2'], setting["lau3"]['p3'], setting["lau3"]['f1'], setting["lau3"]['xmax'], setting["lau3"]['const_f1'], setting["lau3"]['di_gauss'], setting["lau3"]['fix_sigma'])
        self.lau4_model = Lau4Class(x, mu_gauss, cat, setting["lau4"]['sigma'], setting["lau4"]['step'], setting["lau4"]['p1'], setting["lau4"]['p2'], setting["lau4"]['p3'], setting["lau4"]['p4'], setting["lau4"]['f1'], setting["lau4"]['xmax'], setting["lau4"]['const_f1'], setting["lau4"]['di_gauss'], setting["lau4"]['fix_sigma'])
