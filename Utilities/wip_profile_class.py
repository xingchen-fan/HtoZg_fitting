...
class profileClass:
    def __init__(self, x, mu_gauss, cat='', config=''):
        ...
        self.exmg_model = EXMGClass(x, cat, setting["exmg"]['mu_init'], setting["exmg"]['sigma_init'], setting["exmg"]['xsi_init'])
        self.agg_model = AGGClass(x, cat, setting["agg"]['kappa_init'], setting["agg"]['alpha_init'], setting["agg"]['zeta_init'])
