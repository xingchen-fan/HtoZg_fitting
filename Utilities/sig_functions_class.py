...
class combineSignal:
    def __init__(self, x, MH, cat='', config=''):
        ...
        self.model_2016_el_ggf = DSCB_Class(x, MH, cat+"_2016_el_ggf")
        self.model_2016APV_el_ggf = DSCB_Class(x, MH, cat+"_2016APV_el_ggf")
        self.model_2017_el_ggf = DSCB_Class(x, MH, cat+"_2017_el_ggf")
        self.model_2018_el_ggf = DSCB_Class(x, MH, cat+"_2018_el_ggf")
        self.model_2022_el_ggf = DSCB_Class(x, MH, cat+"_2022_el_ggf")
        self.model_2022EE_el_ggf = DSCB_Class(x, MH, cat+"_2022EE_el_ggf")
        self.model_2023_el_ggf = DSCB_Class(x, MH, cat+"_2023_el_ggf")
        self.model_2023BPix_el_ggf = DSCB_Class(x, MH, cat+"_2023BPix_el_ggf")
        self.model_2016_mu_ggf = DSCB_Class(x, MH, cat+"_2016_mu_ggf")
        self.model_2016APV_mu_ggf = DSCB_Class(x, MH, cat+"_2016APV_mu_ggf")
        self.model_2017_mu_ggf = DSCB_Class(x, MH, cat+"_2017_mu_ggf")
        self.model_2018_mu_ggf = DSCB_Class(x, MH, cat+"_2018_mu_ggf")
        self.model_2022_mu_ggf = DSCB_Class(x, MH, cat+"_2022_mu_ggf")
        self.model_2022EE_mu_ggf = DSCB_Class(x, MH, cat+"_2022EE_mu_ggf")
        self.model_2023_mu_ggf = DSCB_Class(x, MH, cat+"_2023_mu_ggf")
        self.model_2023BPix_mu_ggf = DSCB_Class(x, MH, cat+"_2023BPix_mu_ggf")

        self.model_2016_el_vbf = DSCB_Class(x, MH, cat+"_2016_el_vbf")
        self.model_2016APV_el_vbf = DSCB_Class(x, MH, cat+"_2016APV_el_vbf")
        self.model_2017_el_vbf = DSCB_Class(x, MH, cat+"_2017_el_vbf")
        self.model_2018_el_vbf = DSCB_Class(x, MH, cat+"_2018_el_vbf")
        self.model_2022_el_vbf = DSCB_Class(x, MH, cat+"_2022_el_vbf")
        self.model_2022EE_el_vbf = DSCB_Class(x, MH, cat+"_2022EE_el_vbf")
        self.model_2023_el_vbf = DSCB_Class(x, MH, cat+"_2023_el_vbf")
        self.model_2023BPix_el_vbf = DSCB_Class(x, MH, cat+"_2023BPix_el_vbf")
        self.model_2016_mu_vbf = DSCB_Class(x, MH, cat+"_2016_mu_vbf")
        self.model_2016APV_mu_vbf = DSCB_Class(x, MH, cat+"_2016APV_mu_vbf")
        self.model_2017_mu_vbf = DSCB_Class(x, MH, cat+"_2017_mu_vbf")
        self.model_2018_mu_vbf = DSCB_Class(x, MH, cat+"_2018_mu_vbf")
        self.model_2022_mu_vbf = DSCB_Class(x, MH, cat+"_2022_mu_vbf")
        self.model_2022EE_mu_vbf = DSCB_Class(x, MH, cat+"_2022EE_mu_vbf")
        self.model_2023_mu_vbf = DSCB_Class(x, MH, cat+"_2023_mu_vbf")
        self.model_2023BPix_mu_vbf = DSCB_Class(x, MH, cat+"_2023BPix_mu_vbf")
        ...
        self.model_2016_el_ggf.assignVal(config, "2016", cat, "el", "ggf")
        self.model_2016APV_el_ggf.assignVal(config, "2016APV", cat, "el", "ggf")
        self.model_2017_el_ggf.assignVal(config, "2017", cat, "el", "ggf")
        self.model_2018_el_ggf.assignVal(config, "2018", cat, "el", "ggf")
        self.model_2022_el_ggf.assignVal(config, "2022", cat, "el", "ggf")
        self.model_2022EE_el_ggf.assignVal(config, "2022EE", cat, "el", "ggf")
        self.model_2023_el_ggf.assignVal(config, "2023", cat, "el", "ggf")
        self.model_2023BPix_el_ggf.assignVal(config, "2023BPix", cat, "el", "ggf")
        self.model_2016_mu_ggf.assignVal(config, "2016", cat, "mu", "ggf")
        self.model_2016APV_mu_ggf.assignVal(config, "2016APV", cat, "mu", "ggf")
        self.model_2017_mu_ggf.assignVal(config, "2017", cat, "mu", "ggf")
        self.model_2018_mu_ggf.assignVal(config, "2018", cat, "mu", "ggf")
        self.model_2022_mu_ggf.assignVal(config, "2022", cat, "mu", "ggf")
        self.model_2022EE_mu_ggf.assignVal(config, "2022EE", cat, "mu", "ggf")
        self.model_2023_mu_ggf.assignVal(config, "2023", cat, "mu", "ggf")
        self.model_2023BPix_mu_ggf.assignVal(config, "2023BPix", cat, "mu", "ggf")

        self.model_2016_el_vbf.assignVal(config, "2016", cat, "el", "vbf")
        self.model_2016APV_el_vbf.assignVal(config, "2016APV", cat, "el", "vbf")
        self.model_2017_el_vbf.assignVal(config, "2017", cat, "el", "vbf")
        self.model_2018_el_vbf.assignVal(config, "2018", cat, "el", "vbf")
        self.model_2022_el_vbf.assignVal(config, "2022", cat, "el", "vbf")
        self.model_2022EE_el_vbf.assignVal(config, "2022EE", cat, "el", "vbf")
        self.model_2023_el_vbf.assignVal(config, "2023", cat, "el", "vbf")
        self.model_2023BPix_el_vbf.assignVal(config, "2023BPix", cat, "el", "vbf")
        self.model_2016_mu_vbf.assignVal(config, "2016", cat, "mu", "vbf")
        self.model_2016APV_mu_vbf.assignVal(config, "2016APV", cat, "mu", "vbf")
        self.model_2017_mu_vbf.assignVal(config, "2017", cat, "mu", "vbf")
        self.model_2018_mu_vbf.assignVal(config, "2018", cat, "mu", "vbf")
        self.model_2022_mu_vbf.assignVal(config, "2022", cat, "mu", "vbf")
        self.model_2022EE_mu_vbf.assignVal(config, "2022EE", cat, "mu", "vbf")
        self.model_2023_mu_vbf.assignVal(config, "2023", cat, "mu", "vbf")
        self.model_2023BPix_mu_vbf.assignVal(config, "2023BPix", cat, "mu", "vbf")
